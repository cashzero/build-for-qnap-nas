...
case "$OS $ARCH $TYPE" in
        ...
        ;;
        "Linux aarch64 jdk")
                JDK_URL="https://cdn.azul.com/zulu-embedded/bin/zulu11.60.19-ca-jre11.0.17-linux_aarch64.tar.gz"
                JDK_SHA256="8a7a19678a0cb52302fd881030ce69d5ee5e5b1de168ade1d794730e21320bb2"
        ;;
        "Linux armv7l jdk")
